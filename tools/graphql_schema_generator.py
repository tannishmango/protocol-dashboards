...
if __name__ == '__main__':
    subgraph_name = 'makerdao-ethereum'
    ...
    schemas_dir = os.path.join(project_dir + '/graphql_schemas', subgraph_name.replace('-', '_'))

    # Info to download the Thegraph schema
    schema_info = {
        'schema_name': 'subgraph_status_schema',
        'graphql_endpoint': 'https://api.thegraph.com/subgraphs/name/messari/{}'.format(subgraph_name),
